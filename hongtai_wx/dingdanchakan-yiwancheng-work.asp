		...
		<div class="ht_content">
			<div class="hy_list">
				<div class="order_typebox">
					<div class="order_type1 order_type font_gray1">待接受</div>
					<div class="order_type2 order_type font_gray1">进行中</div>
					<div class="order_type3 order_type order_type_border1 font_orange">已完成</div>
				</div>
				<ul class="order_box margintop">
					<li class="">
						<div id="" class="order_list_head">
							<div id="" class="flex">
								<img src="images/ht_53.png" width="15" height="15" />
						...
						<div class="order_centent">
							...
							<div class="order_btn">
								<a href="javascript:;"><button class="work_record_btn2">查看详情</button></a>
							</div>
						...
						<div id="" class="order_list_head" style="border: none;">
							<div id="" class="flex">
								<img src="images/ht_54.png" width="25" height="25" class="shigong" />
								<span id="" class="fw_1 ellipsis">
									客户信息
								</span>
							</div>
						...
						<div class="order_centent">
							...
							<div class="gongren">
								<p class="font_gray">地址：高新高新高新高新高新高新</p>

							</div>
							<div class="order_btn">
								<a href="javascript:;"><button class="order_btn6" style="margin-left: 15px;">评价查看</button></a>
								<a href="javascript:;"><button class="order_btn4" style="margin-left: 15px;">投诉查看</button></a>
							</div>
						</div>
